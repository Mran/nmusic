...
public class Constant {
    public static final String[] TITLE = {"我的", "发现"};
    public static final String[] THREETITLE = {"网易云", "虾米音乐", "QQ音乐"};

    public static final String xiamiBaseUrl = "http://api.xiami.com/";
    public static final String cloudMusicBaseUrl = "http://music.163.com/";
    public static final int DEFAULTTIMEOUT0 = 5*1000;


    public static final int NETEASE_MUSICLIST_DEFUALTSIZE = 20;
    public static final int QQ_MUSICLIST_DEFUALTSIZE = 20;

    public static final String MUSIC_CONTORL_PLAY = "com.mran.nmusic.PLAY";
    ...
    public static final String MUSIC_CONTORL_SONGURL = "MUSIC_CONTORL_SONGURL";
