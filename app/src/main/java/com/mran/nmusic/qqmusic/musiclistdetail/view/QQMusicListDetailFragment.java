...
public class QQMusicListDetailFragment extends BaseFragment implements IQQMusicListDetailFragment, View.OnClickListener, MusiclistDetailAdapter.OnRecyclerItemClickedListener {
    private View view;
    ...
    private QQMusiclistDetailPresenterCompl qqMusiclistDetailPresenterCompl;
    private String listcoverurl;
    private String listid;
    private String listTitle;
    private MainActivity mainActivity;

    public static QQMusicListDetailFragment newInstance(String listcoverurl, String listid, String listTitle) {
        QQMusicListDetailFragment QQMusicListDetailFragment = new QQMusicListDetailFragment();
        Bundle bundle = new Bundle();
        bundle.putString("listcoverurl", listcoverurl);
        bundle.putString("listid", listid);
        bundle.putString("listTitle", listTitle);
        QQMusicListDetailFragment.setArguments(bundle);
        return QQMusicListDetailFragment;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        qqMusiclistDetailPresenterCompl = new QQMusiclistDetailPresenterCompl(BaseApplication.getContext(), this);
